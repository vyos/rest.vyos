    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>List of domain search suffixes.</div>
                </td>
            </tr>
            <tr>
                <td colspan="1">
            ...
            <tr>
                ...
                <td>
                        <div>List of DNS name servers.</div>
            ...
            <tr>
                ...
                <td>
                        <div><code>present</code> applies the configuration.</div>
                        <div><code>absent</code> removes the configuration.</div>
                </td>
            </tr>
    </table>
    <br/>
