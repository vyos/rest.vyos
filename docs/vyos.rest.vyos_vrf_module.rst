...
**Manage VRF configuration on VyOS devices using REST API**
...
Synopsis
--------
- Manages Virtual Routing and Forwarding (VRF) instances on VyOS devices via the REST API.
- Supports merged, replaced, overridden, deleted, and gathered states.
- Protocol configuration within VRFs (BGP, OSPFv2, static routes) is managed inline with focused scope (core fields only).
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Disable IP forwarding for this address family.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Route maps applied per protocol.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Administratively disable this VRF.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Protocol configuration within this VRF instance.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>BGP protocol configuration (core fields only).</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>OSPFv2 protocol configuration (core fields only).</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Static routes configuration.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Desired state of the VRF configuration.</div>
                </td>
            </tr>
    </table>
    <br/>
    ...
    <table border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>when changed</td>
                <td>
                            <div>VRF configuration after this module ran.</div>
                    <br/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                            <div>Current VRF configuration as structured data.</div>
                    <br/>
                </td>
            </tr>
            <tr>
