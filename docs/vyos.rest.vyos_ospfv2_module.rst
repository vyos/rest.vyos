    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Virtual link address (router ID of the remote ABR).</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Virtual link authentication.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>MD5 key (16 characters or less).</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Plain text password (8 characters or less).</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Time (seconds) to advertise self as stub-router before shutdown.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Time (seconds) to advertise self as stub-router on startup.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>MPLS Traffic Engineering parameters.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Interfaces to suppress routing updates on, via per-interface configuration (<code>protocols ospf interface &lt;name&gt; passive</code>).</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Interfaces to explicitly exclude from passive mode (via <code>protocols ospf interface &lt;name&gt; passive disable</code>) -- e.g. when passive is otherwise applied broadly.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Delay (ms) from first change received to SPF calculation.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Initial hold time (ms) between consecutive SPF calculations.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
...
.. seealso::
   ...
   :ref:`vyos.vyos.vyos_ospfv2_module`
      The official documentation on the **vyos.vyos.vyos_ospfv2** module.
